...
import { Check, CirclePlus, MinusCircle, MoreVertical } from "lucide-react";
...
const ScientistTable: React.FC<ScientistTableProps> = ({
  headers,
  rows,
  pagination = false,
  actions,
